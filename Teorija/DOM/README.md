...
Секој објект може да има event handlers прикачени на него и штом тој event е повикан се извршува акција која е поврзана со него.
...
#### Приказ на DOM структура
<img src="https://res.cloudinary.com/practicaldev/image/fetch/s--EUGlr_vF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.tutorialrepublic.com/lib/images/html-dom-illustration.png" alt="DOM" />
